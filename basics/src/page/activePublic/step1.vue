  ...
  <div class="step1">
    ...
    <el-form :model="ruleForm" class="demo-ruleForm" :rules="rules" ref="ruleForm" label-position="top">
      ...
      <el-form-item label="" prop="fenLei">
        ...
        <el-radio-group v-model="ruleForm.fenLei">
          <el-radio v-for="item in ruleForm.fenLeis" :key="item" :label="item.name"></el-radio>
        </el-radio-group>
      </el-form-item>
      ...
      <el-form-item>
        <el-input placeholder="请填写您的广告标题" size="large" v-model="ruleForm.adTitle">
        </el-input>
      </el-form-item>

      <el-form-item>
        <el-input placeholder="请填写您的广告内容" size="large" v-model="ruleForm.adContent">
        </el-input>
      </el-form-item>

      <el-form-item>
        <el-input placeholder="请填写您的赞助链接" size="large" v-model="ruleForm.adLink">
        </el-input>
      </el-form-item>
    ...
    <el-dialog title="添加活动标签" v-model="dialogFormVisible" top="35%">
      ...
      <span slot="footer" class="dialog-footer">
                    ...
                    <el-button type="primary"
                               @click.native="handleAdd(dialogForm.name,dialogForm,ruleForm.tags)">添加</el-button>
                </span>
    </el-dialog>
    ...
    <el-dialog title="设置活动分类" v-model="dialogFormFenLeiVisible">
      <el-form :model="dialogFormFenLei">
        <el-form-item>
          <el-tag v-for="feiLei in ruleForm.fenLeis" :key="feiLei.name" :closable="true" type="primary" @close="handleCloseFenLei(feiLei)">
          {{ feiLei.name }}
          </el-tag>
        </el-form-item>
        <el-form-item>
...
<style>
  ...
  .step1 .el-form-item.is-required .el-form-item_label:after {
    content: '*';
    color: #ff4949;
    margin-right: 4px;
  }
