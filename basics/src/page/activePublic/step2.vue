    ...
    <el-form ref="signForm" :model="signForm" label-position="top" @submit.prevent="onSubmit">
      ...
      <el-form-item label="每人可报名额限制" prop="">
        <el-row>
          ...
          <el-col :span="6">
            <el-input placeholder="0" :number="true" size="large" v-model="signForm.numLimitDetail" :disabled=" signForm.numLimit == '无限制' ">
      ...
      <el-form-item label="付费活动" prop="">
        <el-row>
          ...
          <el-col :span="6">
            <el-input placeholder="0" :number="true" size="large" v-model="signForm.costDetail" :disabled="signForm.cost == '免费'">
      ...
      <el-form-item label="允许取消报名" prop="">
        <el-row>
          ...
          <el-col :span="6">
            <el-input placeholder="活动前几小时" size="large" v-model="signForm.costDetail" :disabled="signForm.cancel == '不允许'">
      ...
      <el-form-item label="设置报名表" prop="" class="setSign">
        ...
        <el-row :gutter="20" v-for="item in signForm.signFormList" :key="item">
          <el-col :span="3">
