  ...
  <div class="page3">
    <el-card class="box-card">
      ...
      <el-row type="flex" align="middle" justify="end" style="padding: 20px 0;">
        <el-pagination @size-change="" @current-change="" :current-page="1" :page-sizes="[100, 200, 300, 400]" :page-size="100" layout="sizes, prev, pager, next" :total="totalItemsNum">
        </el-pagination>
      </el-row>
    </el-card>
...
<script>
  ...
  export default {
    ...
    methods:{
      filerBySearchText:function (val,data) {
